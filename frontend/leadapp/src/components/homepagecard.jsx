...
function Homepagecard(props) {
  ...
  return (
    <>
        ...
        {
           show && <>
            <div className="blackout h-dvh w-full bg-black z-10 opacity-35 fixed -left-[0%] -top-[0%]">  </div>
            <div className="viewbody fixed z-20 flex h-dvh w-full flex justify-center items-center -left-[0%] -top-[0%]">
                <div className="view bg-white h-[70%] w-[60%] mb-[5%] rounded-xl text-slate-500">
                    ...
                    <h1 className='font-semibold text-3xl text-center  mx-16 pb-4 border-b border-cyan-500 mb-6'>{props.name}</h1>
                    <div className="row1 flex justify-between items-center mx-16">
